...
public class IdeaJettyStarter {
    public static void main(String[] a) throws Exception {
        ...
        System.setProperty(HttpJettyRunner.REQUIRED_ENV_VARIABLE_OIDC_REDIRECT_PREFIX,"http://localhost:8082/" /*+ "kjoreseddel/"*/);
        //System.setProperty(HttpJettyRunner.VARIABLE_APP_CONTEXT_PREFIX,"http://localhost:8082/" /*+ "kjoreseddel/"*/);
